...
<h1>EDITAR MATERIA PRIMA</h1>
    <div class="row">
        <div class="col-1"></div>
        <div class="col-10">
            <form action="<?php echo e(route('receta.updateMateriaPrima', $preparado->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                  ...
                  <?php if($materia_prima->id == $preparado->id): ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo e($preparado->cantidad_materia_prima); ?>" id="cantidad_mp" name="cantidad_mp" placeholder="cantidad materia prima">
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelJet\resources\views/receta/preparadocapsula/editar.blade.php ENDPATH**/ ?>