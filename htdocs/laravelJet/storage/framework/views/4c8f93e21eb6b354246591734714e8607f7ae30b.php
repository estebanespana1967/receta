...
<h1>AGREGAR MATERIA PRIMA</h1>
    <div class="row">
        <div class="col-1"></div>
        <div class="col-10">
            <form action="<?php echo e(route('cotizacioncapsula.guardarMateriaPrima')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                  <div class="form-group">
                  <label for="numero_interno">Numero cotizacion</label>
                  <input type="text" class="form-control" id="cotizacion_detalle_id" name="cotizacion_detalle_id" value="<?php echo e($cotizacion->id); ?>" >
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelJet\resources\views/cotizacioncapsula/detalle_capsula/crear.blade.php ENDPATH**/ ?>