...
<td>
<form action="<?php echo e(route('paciente.destroy',$paciente->id)); ?>" method="Post">
<a class="btn btn-primary" href="<?php echo e(route('paciente.edit',$paciente->id)); ?>">Edit</a>
<?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelJet\resources\views/paciente/index.blade.php ENDPATH**/ ?>